...
export const seedData: AppData = {
  ...
  materials: [
    { id: 'mat-1', code: 'MAT-001', name: 'OPC Cement 53 Grade', category: 'Cement', hsnCode: '25232910', unit: 'Bag', standardRate: 410, taxRate: 28, reorderLevel: 100, openingStock: 250, location: 'Rack A1', createdAt: now },
    { id: 'mat-2', code: 'MAT-002', name: 'TMT Steel 12mm', category: 'Steel', hsnCode: '72142090', unit: 'KG', standardRate: 68, taxRate: 18, reorderLevel: 1000, openingStock: 4500, location: 'Yard S2', createdAt: now },
    { id: 'mat-3', code: 'MAT-003', name: 'M-Sand', category: 'Aggregates', hsnCode: '25059000', unit: 'Cft', standardRate: 58, taxRate: 5, reorderLevel: 500, openingStock: 1800, location: 'Open Yard', createdAt: now },
    { id: 'mat-4', code: 'MAT-004', name: '20mm Blue Metal', category: 'Aggregates', hsnCode: '25171010', unit: 'Cft', standardRate: 62, taxRate: 5, reorderLevel: 400, openingStock: 1200, location: 'Open Yard', createdAt: now },
    { id: 'mat-5', code: 'MAT-005', name: 'Red Clay Brick', category: 'Masonry', hsnCode: '69041000', unit: 'Nos', standardRate: 9.5, taxRate: 5, reorderLevel: 3000, openingStock: 8000, location: 'Yard B1', createdAt: now },
  ],
  receipts: [
  ...
  settings: {
    companyName: 'VMV ENTERPRISES',
    gstin: '33BCRPJ7250H1ZF',
    panNo: 'BCRPJ7250H',
    phone: '7402653125',
    email: 'accounts@vmventerprises.in',
    address: 'SY.No.252/2, Plot No.19, AVS Jasmine Valley, Bagalur, Hosur, Krishnagiri, Tamil Nadu, 635103',
    bankName: 'Karnataka bank',
    bankBranch: '74,3RD CROSS,KAMARAJ COLONY, HOSUR, KRISHNAGIRI DISTRICT',
    bankAccountNo: '3482000100081601',
    bankIfsc: 'KARB0000348',
    currency: 'INR',
    defaultTaxRate: 18,
    lowStockAlerts: true,
