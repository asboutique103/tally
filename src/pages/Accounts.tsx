...
export function Accounts() {
  ...
  return <div className="page-stack">
    <PageHeader eyebrow="Double-entry accounting" title="Accounts & vouchers" description="Every bill, material issue and payment automatically creates an accounting entry here — you don't need to post anything manually unless you want to record something extra (like an owner's contribution or a bank charge)." actions={<><button className="button secondary" onClick={exportCurrent}><Download size={17}/> Export</button><button className="button primary" onClick={() => { setDraft(empty()); setOpen(true); }}><Plus size={17}/> Manual voucher</button></>} />
